...
| Tiền lương | payrollService, types/payslip, types/payrollRun, components/hr/payrollDetails | Có phiếu lương cá nhân, lọc kỳ và chi tiết công/thu nhập/khấu trừ/KPI, tải/chia sẻ HTML; tra cứu bảng lương theo kỳ, trạng thái, tìm nhân viên và tổng thực nhận có hiệu lực. Chưa tạo/tính kỳ/công thức/duyệt/chốt/thanh toán, PDF hoặc in native |

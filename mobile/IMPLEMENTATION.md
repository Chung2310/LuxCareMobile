...
| Tiền lương | payrollService, types/payslip, types/payrollRun, types/payrollPayment, types/payrollAdjustment, types/payrollAudit, types/payrollIssue, components/hr/payrollDetails | Có phiếu lương và chia sẻ HTML; tạo kỳ nháp thường theo tháng, đồng bộ công đã tổng hợp và khóa bản công; tra cứu kỳ, tổng tiền, nhân viên; lỗi/cảnh báo kỳ; lịch sử thanh toán; tạo/tra cứu/duyệt/từ chối điều chỉnh; nhật ký kỳ; xuất 4 mẫu Excel; phát hành và thu hồi phiếu theo nhân viên. Chưa tạo kỳ bổ sung/tổng hợp công kỳ/tính kỳ/công thức/duyệt kỳ/chốt/ghi thanh toán/sửa hoặc xóa điều chỉnh, PDF hoặc in native |

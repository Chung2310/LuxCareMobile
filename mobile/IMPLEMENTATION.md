...
| Tiền lương | payrollService, types/payslip, types/payrollRun, types/payrollPayment, types/payrollAdjustment, components/hr/payrollDetails | Có phiếu lương cá nhân và chia sẻ HTML; tra cứu kỳ, nhân viên, tổng thực nhận; lịch sử thanh toán; tra cứu và duyệt/từ chối điều chỉnh pending. Chưa tạo/tính kỳ/công thức/duyệt kỳ/chốt/ghi thanh toán/tạo điều chỉnh, PDF hoặc in native |
